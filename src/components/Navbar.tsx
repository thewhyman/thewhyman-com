...
const PRODUCTS = NAVBAR_EXTERNAL_LINKS.products;
    ...
    <nav className={`fixed top-0 w-full z-[100] px-6 md:px-12 h-24 flex items-center justify-between border-b border-white/10 transition-all duration-300 ${isOpen ? 'bg-black' : 'bg-black/60 backdrop-blur-xl'}`}>
      ...
      <div className="hidden md:flex gap-10 items-center text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">
        ...
        <div className="flex items-center gap-4">
          <a href={NAVBAR_EXTERNAL_LINKS.profiles.github.href} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="GitHub">
          ...
          <a href={NAVBAR_EXTERNAL_LINKS.profiles.linkedin.href} target="_blank" rel="noopener noreferrer" className="hover:text-[#0A66C2] transition-colors" aria-label="LinkedIn">
